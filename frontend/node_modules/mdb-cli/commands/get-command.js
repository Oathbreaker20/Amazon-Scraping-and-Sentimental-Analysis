...
var GetCommand = /*#__PURE__*/function (_Command) {
  ...
  _createClass(GetCommand, [{
    ...
    key: "setReceiver",
    value: function () {
      var _setReceiver = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.t0 = this.entity;
                _context2.next = _context2.t0 === Entity.Backend ? 3 : _context2.t0 === Entity.Frontend ? 5 : _context2.t0 === Entity.Wordpress ? 7 : 9;
                break;
      ...
      function setReceiver() {
        return _setReceiver.apply(this, arguments);
      }
    ...
    key: "detectReceiver",
    value: function () {
      var _detectReceiver = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Receiver.detectEntity(this.context);

              case 2:
                this.entity = _context3.sent;
                _context3.next = 5;
                return this.setReceiver();
