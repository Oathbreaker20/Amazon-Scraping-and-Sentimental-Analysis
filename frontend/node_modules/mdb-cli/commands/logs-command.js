...
var LogsCommand = /*#__PURE__*/function (_Command) {
  _inherits(LogsCommand, _Command);

  var _super = _createSuper(LogsCommand);

  function LogsCommand(context) {
    var _this;

    _classCallCheck(this, LogsCommand);
