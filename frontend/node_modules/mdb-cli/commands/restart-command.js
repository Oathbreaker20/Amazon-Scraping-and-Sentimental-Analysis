...
var RestartCommand = /*#__PURE__*/function (_Command) {
  _inherits(RestartCommand, _Command);

  var _super = _createSuper(RestartCommand);

  function RestartCommand(context) {
    var _this;

    _classCallCheck(this, RestartCommand);
