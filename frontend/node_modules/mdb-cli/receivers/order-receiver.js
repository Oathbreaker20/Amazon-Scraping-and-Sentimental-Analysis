...
var OrderReceiver = /*#__PURE__*/function (_Receiver) {
  _inherits(OrderReceiver, _Receiver);

  var _super = _createSuper(OrderReceiver);

  function OrderReceiver(context) {
    var _this;

    _classCallCheck(this, OrderReceiver);
