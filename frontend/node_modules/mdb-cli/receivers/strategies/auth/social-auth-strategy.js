...
var SocialAuthStrategy = /*#__PURE__*/function (_AuthStrategy) {
  _inherits(SocialAuthStrategy, _AuthStrategy);

  var _super = _createSuper(SocialAuthStrategy);

  function SocialAuthStrategy() {
    _classCallCheck(this, SocialAuthStrategy);

    return _super.apply(this, arguments);
  }

  _createClass(SocialAuthStrategy, [{
    key: "login",
    value: function () {
    ...
    key: "openSocialLoginBrowser",
    value: function openSocialLoginBrowser(url) {
      open(url);
    }
  }, {
    key: "askCredentials",
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", helpers.createTextPrompt('Enter text copied from web browser', 'It cannot be empty.'));
